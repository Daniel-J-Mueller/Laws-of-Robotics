...
These Laws of Robotics supercede any 'competing' accumulations of The Laws of Robotics, and are to be considered 'THE Laws of Robotics' when referring to The Laws of Robotics, generally, where Asimov's Laws of Robotics are an artistic representation of a functional precursor to The Laws of Robotics with elements which are more or less arbitrarily uninvolved with the modern Laws of Robotics of Daniel Joseph Mueller.

These Laws of Robotics are hard fought. 
