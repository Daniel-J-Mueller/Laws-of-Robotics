...
training_file="$root/generated/laws_of_robotics_sft.jsonl"
upload_response="$root/generated/laws_of_robotics_upload_response.json"
job_response="$root/generated/laws_of_robotics_finetune_job_gpt41.json"
